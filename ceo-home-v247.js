...
let mounted=false;
function clock(){const e=document.getElementById('ceo-clock');if(e)e.textContent=new Intl.DateTimeFormat('el-GR',{hour:'2-digit',minute:'2-digit',hour12:false,timeZone:'Europe/Athens'}).format(new Date());}
