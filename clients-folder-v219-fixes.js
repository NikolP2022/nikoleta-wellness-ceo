...
function bind(){
 ...
 document.querySelectorAll('[data-edit]').forEach(b=>{if(b.__bound)return;b.__bound=1;b.onclick=e=>{e.preventDefault();e.stopImmediatePropagation();const fn=window.__NWCEO_CF218_OPEN_EDIT;if(fn)fn(b.dataset.edit)}});
}
